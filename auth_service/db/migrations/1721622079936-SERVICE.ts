...
export class SERVICE1721622079936 implements MigrationInterface {
    name = 'SERVICE1721622079936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "nickname" character varying NOT NULL, "isBlock" boolean NOT NULL, "bio" text NOT NULL, "photoAvatar" character varying, "photoBackground" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "googleId" character varying, "facebookId" character varying, CONSTRAINT "UQ_065d4d8f3b5adb4a08841eae3c8" UNIQUE ("name"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
